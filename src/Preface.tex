...
A decimal time system is not unheard of. The French and Chinese have \fhref{done it}{https://en.wikipedia.org/wiki/Decimal\_time}. It just never became a global standard. Similarly, \fhref{gradian}{https://en.wikipedia.org/wiki/Gradian} is an alternative to degrees or radians in angle measurement. 100 gradians make a quadrant, and 400 make a circle.
...
Moreover, since the SI also defines ten  \fhref{metric prefixes}{https://en.wikipedia.org/wiki/Metric\_prefix}, might as well make full use of them.
